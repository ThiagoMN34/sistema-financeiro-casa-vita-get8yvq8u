...
//   address_state: text (nullable)
//   address_zip: text (nullable)
//   legal_representative_name: text (nullable)
//   legal_representative_cpf: text (nullable)
//   legal_representative_rg: text (nullable)
//   email: text (nullable)
//   phone: text (nullable)
//   bank_name: text (nullable)
...
// Table: providers
//   PRIMARY KEY providers_pkey: PRIMARY KEY (id)
// Table: shift_rates
...
//     USING: (get_user_role() = 'ADMIN'::text)
// Table: providers
//   Policy "auth_all_providers" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: shift_rates
