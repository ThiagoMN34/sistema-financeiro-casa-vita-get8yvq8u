-- Force reset user password and clear nulls properly with single dollar signs
...
BEGIN
  ...
  -- 3. Fix NULL tokens bug that prevents login in Supabase GoTrue
  UPDATE auth.users
  SET
  ...
  -- 4. Reset thiagomnaves@yahoo.com.br
